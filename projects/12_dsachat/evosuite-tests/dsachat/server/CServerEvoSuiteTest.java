...
public class CServerEvoSuiteTest {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
          ...
          CServer cServer0 = null;
          try {
            cServer0 = new CServer(1958, handler0);
            fail("Expecting exception: SecurityException");
          } catch(SecurityException e) {
            /*
             * Security manager blocks (java.net.SocketPermission localhost:1958 listen,resolve)
             ...
             * dsachat.server.CServer.<init>(CServer.java:29)
