...
public class RegressionTest0 {
    ...
    public void test131() throws Throwable {
        ...
        java.util.Vector vector10 = null;
        com.ib.client.Contract contract15 = new com.ib.client.Contract((int) (short) 10, "", "", "hi!", (double) '4', "hi!", "hi!", "hi!", "hi!", "hi!", vector10, "", false, "", "");
    }
    ...
    public void test136() throws Throwable {
        ...
        java.lang.String str23 = contract15.m_comboLegsDescrip;
        java.lang.String str24 = contract15.m_primaryExch;
        java.lang.String str25 = contract15.m_exchange;
        org.junit.Assert.assertTrue("'" + str16 + "' != '" + "hi!" + "'", str16.equals("hi!"));
        org.junit.Assert.assertNull(str23);
        org.junit.Assert.assertTrue("'" + str24 + "' != '" + "" + "'", str24.equals(""));
        org.junit.Assert.assertTrue("'" + str25 + "' != '" + "hi!" + "'", str25.equals("hi!"));
    ...
    public void test140() throws Throwable {
        ...
        com.ib.client.Contract contract0 = new com.ib.client.Contract();
    }
    ...
    public void test142() throws Throwable {
        ...
        java.lang.String str27 = contract15.m_secType;
        org.junit.Assert.assertTrue("'" + str16 + "' != '" + "hi!" + "'", str16.equals("hi!"));
        org.junit.Assert.assertTrue("'" + str23 + "' != '" + "" + "'", str23.equals(""));
        org.junit.Assert.assertNull(vector24);
        org.junit.Assert.assertTrue("'" + str27 + "' != '" + "hi!" + "'", str27.equals("hi!"));
    ...
    public void test144() throws Throwable {
        ...
        com.ib.client.Contract contract35 = new com.ib.client.Contract(0, "hi!", "hi!", "", (double) (short) 10, "hi!", "", "", "hi!", "", vector30, "", false, "hi!", "hi!");
        java.lang.String str36 = contract35.m_currency;
        contract35.m_secIdType = "hi!";
        com.ib.client.UnderComp underComp39 = null;
        contract35.m_underComp = underComp39;
        contract35.m_exchange = "hi!";
        java.lang.String str43 = contract35.m_comboLegsDescrip;
        java.lang.String str44 = contract35.m_primaryExch;
        boolean boolean45 = contract15.equals((java.lang.Object) contract35);
        org.junit.Assert.assertTrue("'" + str18 + "' != '" + "hi!" + "'", str18.equals("hi!"));
    ...
    public void test145() throws Throwable {
        ...
        contract15.m_expiry = "";
        java.lang.String str22 = contract15.m_secId;
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + false + "'", boolean17 == false);
        org.junit.Assert.assertTrue("'" + str22 + "' != '" + "hi!" + "'", str22.equals("hi!"));
    }
    ...
    public void test147() throws Throwable {
        ...
        contract15.m_secId = "hi!";
        java.lang.String str24 = contract15.m_primaryExch;
        java.util.Vector vector25 = contract15.m_comboLegs;
        org.junit.Assert.assertTrue("'" + str16 + "' != '" + "hi!" + "'", str16.equals("hi!"));
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + false + "'", boolean18 == false);
        org.junit.Assert.assertTrue("'" + str19 + "' != '" + "" + "'", str19.equals(""));
        org.junit.Assert.assertTrue("'" + str20 + "' != '" + "hi!" + "'", str20.equals("hi!"));
        org.junit.Assert.assertNull(underComp21);
        org.junit.Assert.assertTrue("'" + str24 + "' != '" + "" + "'", str24.equals(""));
        org.junit.Assert.assertNull(vector25);
    }
    ...
    public void test150() throws Throwable {
        ...
        java.lang.String str19 = contract15.m_expiry;
        java.lang.String str20 = contract15.m_right;
        java.util.Vector vector21 = contract15.m_comboLegs;
        org.junit.Assert.assertTrue("'" + str16 + "' != '" + "hi!" + "'", str16.equals("hi!"));
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + false + "'", boolean18 == false);
        org.junit.Assert.assertTrue("'" + str19 + "' != '" + "" + "'", str19.equals(""));
        org.junit.Assert.assertTrue("'" + str20 + "' != '" + "hi!" + "'", str20.equals("hi!"));
        org.junit.Assert.assertNull(vector21);
    }
    ...
    public void test154() throws Throwable {
        ...
        com.ib.client.Contract contract15 = new com.ib.client.Contract((int) (short) 10, "", "", "hi!", (double) 100.0f, "", "", "hi!", "hi!", "", vector10, "", false, "", "hi!");
        java.lang.String str16 = contract15.m_currency;
        java.lang.String str17 = contract15.m_localSymbol;
        org.junit.Assert.assertTrue("'" + str16 + "' != '" + "hi!" + "'", str16.equals("hi!"));
        org.junit.Assert.assertTrue("'" + str17 + "' != '" + "" + "'", str17.equals(""));
    }
}
